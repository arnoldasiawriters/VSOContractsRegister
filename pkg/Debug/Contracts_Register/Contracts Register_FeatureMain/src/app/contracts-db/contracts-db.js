(function () {
    ...
    ContractsCtrlFunction.$inject = ['$q', '$route','$routeParams', '$dialog', '$dialogAlert', 'contractsSvc', 'departmentsSvc', 'spinnerService', 'growl', 'settingsSvc'];
    function ContractsCtrlFunction($q, $route, $routeParams, $dialog, $dialogAlert, contractsSvc, departmentsSvc, spinnerService, growl, settingsSvc) {
        var ctrl = this;
